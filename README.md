...
- `/register` - Зарегистрироваться (только до жеребьёвки)
- `/myinfo` - Посмотреть свою информацию
- `/updatewishes <текст>` - Обновить пожелания (только до жеребьёвки)
- `/update_destination <текст>` - Обновить адрес доставки (только до жеребьёвки)
- `/updatephone <номер>` - Обновить номер телефона (только до жеребьёвки)
